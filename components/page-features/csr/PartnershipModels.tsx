    ...
    <section className="bg-[#fbf8f2] px-5 py-5">
      <div className="mx-auto max-w-7xl">
              ...
              <div className="relative min-h-[165px] px-6 pb-7 pt-5">
                <div className="flex gap-4">
                  <span className="grid h-[72px] w-[72px] shrink-0 place-items-center rounded-full border-[3px] border-[#c58c2b] bg-[#00503e] text-white">
                    <CSRIcon name={model.icon} className="h-11 w-11" />
                  </span>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[16px] font-medium leading-[1.4] text-[#3c4041]">{model.text}</p>
                  </div>
                </div>
        ...
        <div className="mt-3 flex justify-center">
          <a href="#csr-enquiry" className="inline-flex h-[48px] w-full max-w-[340px] items-center justify-between rounded-[7px] border border-[#c79231] bg-[#004a38] px-5 text-[16px] font-bold uppercase text-white shadow">
