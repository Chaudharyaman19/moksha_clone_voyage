...
import { FaHandHoldingHeart, FaLeaf, FaPhoneAlt, FaHandsHelping, FaHeart } from "react-icons/fa";
      ...
      <main className="pt-24 pb-16 lg:pt-32 lg:pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex flex-col items-start relative z-10 order-2 lg:order-1">
              <div className="inline-flex items-center justify-center p-4 bg-white/80 rounded-full shadow-sm mb-6 backdrop-blur-md border border-[#E8DCC8]">
                <FaHandsHelping className="w-8 h-8 text-[#A0522D]" />
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-[#3E2723] mb-6 leading-tight tracking-tight">
                Family & Extra Support
                <span className="font-medium text-[#8D6E63] italic mt-2 block text-3xl md:text-4xl">Standing Beside You, Always.</span>
              </h1>
              <p className="text-lg md:text-xl text-[#5D4037] leading-relaxed opacity-95 mb-8">
                Beyond the final rites, Moksha Sewa helps families with post-cremation arrangements like Tehravi Khana (13th day meal) and continuous emotional support, completely free of charge for those in need.
              </p>
            ...
            <div className="relative h-[400px] lg:h-[550px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl order-1 lg:order-2">
              <Image 
                src="/assets/serving/community-outreach.png"
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-medium text-[#4A3D36] mb-4">How We Extend Our Help</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ItemCard 
              ...
              desc="Providing counseling and a sympathetic ear to families navigating through intense grief, ensuring they feel supported."
            />
            <ItemCard 
              icon={<MdOutlineFoodBank className="w-8 h-8" />}
              title="Tehravi Khana Arrangement"
              desc="For the underprivileged, we manage and arrange the Tehravi Khana (13th day meal) respectfully and without any burden."
            />
            <ItemCard 
              icon={<BiSupport className="w-8 h-8" />}
              title="End-to-End Assistance"
              desc="From death certificates to legal procedures, our volunteers try to help the family navigate post-cremation formalities."
            />
          </div>
        </section>
        ...
        <section className="w-full bg-gradient-to-br from-[#F5F0EA] to-[#FDFBF7] py-24 px-4 sm:px-6 lg:px-8 border-t border-[#E8DCC8]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h3 className="text-2xl md:text-3xl font-light text-[#5D4037] mb-8 italic leading-relaxed">
              "We are an extended family for those who have none, or those who need one."
            </h3>
