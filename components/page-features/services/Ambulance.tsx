          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex flex-col items-start relative z-10">
              <div className="inline-flex items-center justify-center p-4 bg-white/80 rounded-full shadow-sm mb-6 backdrop-blur-md border border-[#E8DCC8]">
                <FaAmbulance className="w-8 h-8 text-[#A0522D]" />
              </div>
              ...
              <p className="text-lg md:text-xl text-[#5D4037] leading-relaxed opacity-95 mb-8">
                In times of sudden loss, arranging transport can be overwhelming. We provide quick and respectful ambulance and hearse van (Shav Vahan) services to transport your loved one with the utmost dignity, completely free for underprivileged families.
              </p>
            ...
            <div className="relative h-[400px] lg:h-[550px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl">
              <Image 
                ...
                alt="Moksha Sewa Ambulance Service"
                fill
