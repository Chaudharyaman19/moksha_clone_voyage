...
export default function AboutNamoGange() {
  return (
    <section className="relative w-full overflow-hidden bg-[#fbf5ea] px-3 py-6 sm:px-4 md:py-7 lg:px-5">
      ...
      {/* Subtle Watermark */}
      <div className="pointer-events-none absolute left-[55%] top-[15%] select-none text-[180px] font-semibold leading-none text-[#8B6A3E]/[0.03]" style={{ fontFamily: "Georgia, serif" }}>
        NAMO
      </div>
