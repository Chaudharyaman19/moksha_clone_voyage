...
export const defaultPrayerHallSections: ExtraSectionContent[] = [
  ...
  },
  {
    ...
    enabled: true,
    items: [
      { title: "Ground Coordination", description: "Seamless coordination with staff and family members.", image: "https://res.cloudinary.com/dr8mld4i0/image/upload/v1787830378/moksha-sewa/website/dg2yjxz0ws8f6xmanbgd.png" },
